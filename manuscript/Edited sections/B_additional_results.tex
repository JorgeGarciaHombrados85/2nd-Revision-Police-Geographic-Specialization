...
\input{../manuscript/Figures/Map Plan Cuadrante}

\input{Tables/Table Comparing Samples}
...
\input{../manuscript/Figures/FigureA8_typecrimes}
\clearpage
...
\input{Tables/table_controlbyresources_csdid}
...
\input{Tables/table_resourcecorrelates}
...
\input{../manuscript/Figures/figureA5_SC}
\clearpage
...
\input{../manuscript/Figures/FigureA7B_corrnovariation}
\clearpage

\FloatBarrier
\input{../manuscript/Figures/figure_heterogeneity_appendix}
\FloatBarrier
\clearpage
...
\input{../manuscript/Figures/Police effectiveness correlations with PC year}
\clearpage