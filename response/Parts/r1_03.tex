...
Table \ref{tab:results_controlbyresources} below reproduces the table exactly as it appeared in the previous version of the paper:

\input{../manuscript/Tables/table_controlbyresources_csdid}

%TODO: insert corrected table here once re-estimated. Only column (2) of Panel D changes: restricting to 2006--2012 (dropping 2013--2016) leaves N approx 1,918 municipality-years, but the ATT and standard error must be re-estimated with the Callaway and Sant'Anna estimator on the corrected sample -- do not fabricate these numbers. Columns (1), (3), (4) and (5) are unaffected, since they were already restricted to their own resource-availability window. Also update the table note to state the years used in each column.
